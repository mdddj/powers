---
name: "salvo-rust"
displayName: "Salvo Rust Web Framework"
description: "用 Rust 编写的简单而强大的 Web 框架。统一的 Handler/Middleware 设计，灵活的路由系统，支持 OpenAPI、JWT、CORS、限流等丰富功能。"
keywords: ["salvo", "rust", "web", "framework", "api", "http", "server", "middleware", "router", "openapi", "jwt", "cors", "web框架", "路由", "中间件"]
---
